        ...
        <div key={branch.id} className="relative overflow-hidden bg-black flex-shrink-0 w-full">
          ...
          <div ref={moveDiv} className="flex flex-col absolute w-full duration-300" style={see ? {bottom: 0} : myStyle}>
            <div className="flex justify-center">
              <Link href={'/reservation'} className='font-jockey border-2 py-1 sm:py-2 px-6 sm:px-8 sm:text-xl md:text-2xl rounded bg-smoke text-body hover:text-smoke hover:bg-transparent duration-300 tracking-wide'>RESERV</Link>
            </div>
            ...
            <div className="flex flex-col text-smoke px-10 font-jaldi bg-gradient-to-t from-black to-transparent">
              <div className="flex flex-col items-center mt-5">
                ...
                <h3 className='text-xl sm:text-3xl md:text-5xl mb-3 sm:mb-6 font-jockey'>{branch.name}</h3>
              </div>
              
              <div ref={description} className="flex flex-col items-center text-xs sm:text-sm md:text-base">
